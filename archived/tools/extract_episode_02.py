#!/usr/bin/env python3
"""
Extract EnglishPod Episodes 101-200 (Playlist 2)

This script extracts all videos from the second playlist
and saves them to youtube_descriptions/Episode_02/

Playlist: https://www.youtube.com/playlist?list=PL6vHaAQyQlk8Vwa7S2eQ2kcFQNb2chipE
"""
...
# Playlist URL for Episodes 101-200
PLAYLIST_URL = "https://www.youtube.com/playlist?list=PL6vHaAQyQlk8Vwa7S2eQ2kcFQNb2chipE"
OUTPUT_DIR = Path("youtube_descriptions/Episode_02")
...
async def main():
    ...
    print("""
╔══════════════════════════════════════════════════════════════════════════════╗
║           ENGLISHPOD EPISODES 101-200 EXTRACTOR                              ║
║           Playlist 2 - Episode_02 Folder                                     ║
╚══════════════════════════════════════════════════════════════════════════════╝
    """)
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            # Process each video (starting from 101)
            successful = 0
            failed = 0
            
            for i, video_url in enumerate(video_urls, 101):  # Start from 101
            ...
            if successful > 0:
                ...
                print("   This will generate the TypeScript file with Episodes 101-200!")
