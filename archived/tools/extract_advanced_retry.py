#!/usr/bin/env python3
"""
Extract Advanced Playlist - RETRY VERSION with longer timeouts
...
PLAYLIST_URL = "https://www.youtube.com/playlist?list=PL6vHaAQyQlk9G-4w1grcLPvjBdhOQC6Ma"
OUTPUT_DIR = Path("youtube_descriptions/Advanced")
VIDEO_TITLES = {}
...
async def get_playlist_videos(page):
    ...
    for i in range(20):  # More scrolls to ensure all videos load
...
async def main():
    ...
    print("""
╔══════════════════════════════════════════════════════════════════════════════╗
║           ADVANCED PLAYLIST EXTRACTOR - RETRY VERSION                        ║
║           Folder: Advanced                                                   ║
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            for i, video_url in enumerate(video_urls, 1):
                ...
                if i < len(video_urls):
                    await asyncio.sleep(2)  # Longer delay between videos
            ...
            if successful > 0:
                rename_files()
                print("\n🎉 COMPLETE!")
                print(f"✅ Extracted {successful} Advanced episodes")
