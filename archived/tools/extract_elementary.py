#!/usr/bin/env python3
"""
Extract Elementary Playlist and Auto-Rename

This script:
1. Extracts all videos from the Elementary playlist
2. Saves them to youtube_descriptions/Elementary/
...
# Playlist URL for Elementary
PLAYLIST_URL = "https://www.youtube.com/playlist?list=PL6vHaAQyQlk9L_lA9O4O-tRqT_zljx-lb"
OUTPUT_DIR = Path("youtube_descriptions/Elementary")
...
╚══════════════════════════════════════════════════════════════════════════════╝
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            # Process each video (starting from 1)
            successful = 0
            failed = 0
            ...
            if successful > 0:
                ...
                print("\n🎉 COMPLETE!")
                print(f"✅ Extracted {successful} Elementary episodes")
