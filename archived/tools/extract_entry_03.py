#!/usr/bin/env python3
"""
Extract Entry_03 Playlist (EnglishPod 201-300) and Auto-Rename

This script:
1. Extracts all videos from the Entry_03 playlist
2. Saves them to audio_source/Entry_03/
3. Automatically renames files with titles after extraction

Playlist: https://www.youtube.com/playlist?list=PL6vHaAQyQlk8kP1SPJ9uvDcNA4Ujb6hue
"""
...
# Playlist URL for Entry_03 (EnglishPod 201-300)
...
╚══════════════════════════════════════════════════════════════════════════════╝
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            # Process each video (starting from 201 for EnglishPod 201-300)
            successful = 0
            failed = 0
            
            for i, video_url in enumerate(video_urls, 201):
            ...
            if successful > 0:
                ...
                print("\n🎉 COMPLETE!")
                print(f"✅ Extracted {successful} Entry_03 episodes (EnglishPod 201-300)")
