#!/usr/bin/env python3
"""
Rename Episode_02 files with video titles

This script reads the HTML files in Episode_02, extracts titles,
and renames files to include the title.
"""
...
def rename_episode_02_files():
    """Rename all HTML files in Episode_02 folder"""
...
if __name__ == '__main__':
    print("""
╔══════════════════════════════════════════════════════════════════════════════╗
║                   RENAME EPISODE_02 FILES                                    ║
╚══════════════════════════════════════════════════════════════════════════════╝
    """)
    
    rename_episode_02_files()
    
    print("\n✅ Done! Episode_02 files now include video titles.")
