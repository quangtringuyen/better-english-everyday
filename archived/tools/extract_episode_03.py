#!/usr/bin/env python3
"""
Extract EnglishPod Episodes 140+ (Playlist 3) and Auto-Rename

This script:
1. Extracts all videos from the third playlist
2. Saves them to youtube_descriptions/Episode_03/
...
async def main():
    ...
    print("""
╔══════════════════════════════════════════════════════════════════════════════╗
║           ENGLISHPOD EPISODES 140+ EXTRACTOR                                 ║
║           Playlist 3 - Episode_03 Folder                                     ║
...
╚══════════════════════════════════════════════════════════════════════════════╝
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            # Process each video (starting from 140)
            successful = 0
            failed = 0
            
            for i, video_url in enumerate(video_urls, 140):  # Start from 140
            ...
            if successful > 0:
                ...
                print("\n🎉 COMPLETE!")
                print(f"✅ Extracted {successful} episodes")
