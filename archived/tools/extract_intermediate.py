#!/usr/bin/env python3
"""
Extract Intermediate Playlist and Auto-Rename
...
PLAYLIST_URL = "https://www.youtube.com/playlist?list=PL6vHaAQyQlk9IInEy2bLpkaNlEt8JMCNB"
OUTPUT_DIR = Path("youtube_descriptions/Intermediate")
VIDEO_TITLES = {}
...
async def main():
    ...
    print("""
╔══════════════════════════════════════════════════════════════════════════════╗
║           INTERMEDIATE PLAYLIST EXTRACTOR                                    ║
║           Folder: Intermediate                                               ║
╚══════════════════════════════════════════════════════════════════════════════╝
    """)
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            if successful > 0:
                rename_files()
                print("\n🎉 COMPLETE!")
                print(f"✅ Extracted {successful} Intermediate episodes")
