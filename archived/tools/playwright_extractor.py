#!/usr/bin/env python3
"""
Automated YouTube Playlist Extractor using Playwright
...
async def get_playlist_videos(page):
    ...
    for i in range(15):  # Scroll multiple times
...
╚══════════════════════════════════════════════════════════════════════════════╝
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            # For automation, process all videos
            # You can change this to process a specific number
